...
class SuffixTree
{
	...
	public int dfs(Node n,int x, int answer)
	{
		if(n.b>=x)
		{
			return n.a+1;
...
public class glass-beads {
	...
	public static void main(String[] args) throws IOException{
		...
		for(int i=0;i<cases;i++)
		{
			st = new StringTokenizer(stdin.readLine());
			line = st.nextToken();
			suffix = new SuffixTree(line+line);
			sb.append(suffix.dfs(suffix.root,line.length(), 0)).append("\n");
		}
		System.out.print(sb);
